// ============================================================================
// Module: private-endpoint (data)
// Purpose: Deploys a Private Endpoint and DNS Zone Group for a data-tier service.
...
var peName = '${orgPrefix}-${environmentName}-data-${regionShort}-pe-${instance}'
